...
class AmountColumn extends Component {
  ...
  handleOnMouseOver(event) {
    ...
    const { amountColumnSelected } = this.state;
    const selectedCells2 = document.querySelectorAll(`.${amountColumnSelected}`);
